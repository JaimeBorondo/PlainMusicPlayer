...
:doit
if /i "%1#" == "--libs#"    echo -LC:/Users/Boron/Downloads/develop/lib/installed/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IC:/Users/Boron/Downloads/develop/lib/installed/include/taglib
if /i "%1#" == "--version#" echo 1.9.1
if /i "%1#" == "--prefix#"  echo C:/Users/Boron/Downloads/develop/lib/installed
