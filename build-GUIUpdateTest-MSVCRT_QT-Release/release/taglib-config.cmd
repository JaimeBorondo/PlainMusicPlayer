...
:doit
if /i "%1#" == "--libs#"    echo -Le:/workspace/lib/installed/lib -llibtag
if /i "%1#" == "--cflags#"  echo -Ie:/workspace/lib/installed/include/taglib
if /i "%1#" == "--version#" echo 1.9.1
if /i "%1#" == "--prefix#"  echo e:/workspace/lib/installed
